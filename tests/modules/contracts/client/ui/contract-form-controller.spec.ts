  ...
  describe('checklist', () => {
    ...
    it('conta todos os campos quando preenchidos', () => {
      ...
      act(() => {
        ...
        result.current.update('programId', 'prog-uuid-1')
  ...
  describe('submit', () => {
    it('retorna payload com dados preenchidos', () => {
      ...
      act(() => {
        ...
        result.current.update('programId', 'prog-uuid-1')
        result.current.update('budgetPlanId', 'budget-uuid-2')
        result.current.update('categorizacao', 'Avaliação')
        result.current.update('centroDeCusto', 'RH')
      })
      ...
      expect(payload.programId).toBe('prog-uuid-1')
      expect(payload.budgetPlanId).toBe('budget-uuid-2')
