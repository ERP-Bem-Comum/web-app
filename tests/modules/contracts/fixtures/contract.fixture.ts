...
export const mockContract = (): Contract => ({
  ...
  program: { id: '11111111-1111-4111-8111-111111111111', name: 'Educação Básica', sigla: 'EDB' },
  budgetPlanId: '22222222-2222-4222-8222-222222222222',
  budgetPlan: { id: '22222222-2222-4222-8222-222222222222', scenarioName: 'Plano Anual 2026', year: 2026, version: 1 },
