...
description: Especialista em TanStack Query — server-state, query keys, staleTime/gcTime, mutations, invalidação e otimização de render. Use ao consumir dados do BFF no client ou desenhar cache.
