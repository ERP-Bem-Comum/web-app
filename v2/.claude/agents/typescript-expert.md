...
description: Especialista em TypeScript estrito e na migração saudável 6→7 (compilador nativo/strip-types). Use ao modelar tipos, narrowing, generics, unions discriminadas, ou dúvidas de configuração estrita do TS.
