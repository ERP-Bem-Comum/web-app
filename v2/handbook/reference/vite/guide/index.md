...
[Learn Vite through interactive tutorials on Scrimba](https://scrimba.com/intro-to-vite-c03p6pbbdq?via=vite "Free Vite Course on Scrimba")
...
[Watch an interactive lesson on Scrimba](https://scrimba.com/intro-to-vite-c03p6pbbdq/~0yhj?via=vite "Scaffolding Your First Vite Project")

> **Note:** Vite requires [Node.js](https://nodejs.org/en/) version 20.19+, 22.12+. However, some templates require a higher Node.js version to work, please upgrade if your package manager warns about it.
...
To learn more about how and when Vite does releases, check out the [Releases](./../releases) documentation.

> **Note:** To replace the Vite version used by dependencies transitively, you should use [npm overrides](https://docs.npmjs.com/cli/v11/configuring-npm/package-json#overrides) or [pnpm overrides](https://pnpm.io/9.x/package_json#pnpmoverrides).
