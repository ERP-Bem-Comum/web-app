...
export type RetentionInput = Readonly<{ type: RetentionType; baseCents: string; rateBps: number; valueCents: string }>
export type RegisteredTaxInput = Readonly<{ type: RegisteredTaxType; baseCents: string; rateBps: number; valueCents: string }>
