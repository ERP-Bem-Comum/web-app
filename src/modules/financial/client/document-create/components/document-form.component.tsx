    ...
    <>
      ...
      <section className={section}>
        ...
        <div className={fieldGrid.six}>
          ...
          <div className={field}>
            <label className={fieldLabel} htmlFor="fin-num">
              {t('financial.create.field.documentNumber')}
            </label>
            <input
              id="fin-num"
              className={control}
          ...
          <div className={field}>
            <label className={fieldLabel} htmlFor="fin-serie">
              {t('financial.create.field.series')}
            </label>
            <input
              id="fin-serie"
              className={control}
