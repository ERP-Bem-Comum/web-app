...
export const gabaritoDanfseV2: Gabarito = {
  ...
  campos: [
    ...
    // CNPJ/CPF do EMITENTE (prestador) — ancora em "EMITENTE", 1º documento antes do TOMADOR. Habilita a
    // auto-seleção do fornecedor pelo leitor client-side (matchPartnerByTaxId).
    {
      nome: 'supplierCnpj',
      tipo: 'texto',
      estrategia: {
