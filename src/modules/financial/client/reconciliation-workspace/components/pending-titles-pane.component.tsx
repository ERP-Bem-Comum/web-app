 ...
 * no painel de sugestões quando NÃO há extrato importado na sessão — para a aba não ficar vazia. Ordenado
 * pela DATA DE PAGAMENTO (a data relevante p/ a conciliação), mais antigo no topo. Apenas informativo
 * (conciliar exige um movimento do extrato): reaproveita o visual do `altCard`. Com extrato, o fluxo de
 * sugestão da `SuggestionPane` é respeitado (este pane não aparece).
 */
