...
import {
  ...
  createReopenCedenteAccount,
  createDeleteCedenteAccount,
...
const build = () => {
  ...
  return {
    ...
    reopenCedenteAccount: createReopenCedenteAccount({ client }),
    deleteCedenteAccount: createDeleteCedenteAccount({ client }),
