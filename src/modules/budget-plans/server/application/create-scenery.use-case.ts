 ...
 * = cenário criado. Erros como valores (§II): 409 → `budget-plan-scenery-needs-draft` (cenário só em plano
 * NÃO aprovado). O PORT vive aqui (application); o adapter o implementa (§ server).
 */
