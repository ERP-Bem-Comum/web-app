...
export type InsightsYear = Readonly<{
  year: number
  totalInCents: number
  /** #416: Σ conciliado do ano (fonte da P.O.). `null` = core-api não expõe → a UI mostra "—". */
...
export type BudgetPlanInsights = Readonly<{
  ...
  /** #416: nº de Redes do plano — a média por rede é derivada AQUI no front. `null` = não exposto. */
