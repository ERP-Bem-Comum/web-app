...
/* Painel expansível de filtros (legado) — grade alinhada, colunas uniformes */
export const panel = style({
  display: 'grid',
  // 6 colunas em telas largas → os 10 campos preenchem linha 1 (6) + linha 2 (4), e o footer
  // (span 2) cai nas 2 últimas células da linha 2. Sem 3ª linha → ganha espaço.
  ...
  '@media': {
    ...
    '(min-width: 90rem)': { gridTemplateColumns: 'repeat(6, minmax(0, 1fr))' },
  },
})
...
export const fieldLabel = style({
  ...
  color: vars.color.text.secondary,
  // Linha única → todos os controles alinham na mesma altura.
  whiteSpace: 'nowrap',
  overflow: 'hidden',
...
export const panelFooter = style({
  // Ocupa as últimas células da grade (alinha com a 2ª linha de campos) em vez de uma linha própria.
  gridColumn: 'span 2',
  alignSelf: 'end',
  display: 'flex',
