...
import { grid, gridFull, gatedNote, section, sectionTitle, select, textarea } from './collaborator-detail-content.css.ts'
...
export function CollaboratorDetailContent({ controller: c, editing, showComplete, preTitle }: CollaboratorDetailContentProps): ReactNode {
  ...
  const gatedTxt = (id: string, label: string, placeholder?: string): ReactNode => (
    <Field htmlFor={`cd-${id}`} label={label}>
      <Input id={`cd-${id}`} value="" placeholder={placeholder} disabled onChange={() => { /* gated */ }} />
    </Field>
  )
  const gatedSel = (id: string, label: string, options: readonly Readonly<{ value: string; label: string }>[]): ReactNode => (
    <Field htmlFor={`cd-${id}`} label={label}>
      ...
      <section className={section}>
        ...
        <div className={grid}>
          ...
          <Field htmlFor="cd-pix-type" label={t('partners.collaborators.form.pixKeyType')}>
            <select id="cd-pix-type" className={select} disabled defaultValue="" aria-label={t('partners.collaborators.form.pixKeyType')}>
              <option value="">{t('partners.collaborators.form.select')}</option>
        ...
        <>
          ...
          <section className={section}>
            ...
            <div className={grid}>
              ...
              {gatedSel('maritalStatus', t('partners.collaborators.detail.field.maritalStatus'), maritalOptions)}
          ...
          <section className={section}>
            ...
            <div className={grid}>
              ...
              {gatedTxt('children-ages', t('partners.collaborators.detail.field.childrenAges'), t('partners.collaborators.detail.field.childrenAgesPlaceholder'))}
            </div>
          </section>
          ...
          <section className={section}>
            ...
            <div className={grid}>
              ...
              {gatedTxt('leave-renewal-duration', t('partners.collaborators.detail.field.leaveRenewalDuration'))}
            </div>
          </section>
