 ...
 * (`setTimeout`, sem lib). Comita (navega) após a pausa; sincroniza quando o valor externo (URL) muda.
 * Espelha o controller de filtros do ACT.
 */
...
export function useDebouncedSearch(
  ...
  useEffect(() => {
    ...
    const handle = setTimeout(() => { onCommitRef.current(value) }, delayMs)
