...
import { paginator, label, button, perPageWrap, perPageSelect } from './users-paginator.css.ts'

const PER_PAGE_OPTIONS = [5, 10, 25] as const

export type UsersPaginatorProps = Readonly<{
  page: number
  totalPages: number
  perPage: number
...
export function UsersPaginator(props: UsersPaginatorProps): ReactNode {
  return (
