...
export const ptBR: Catalog = {
  ...
  'financial.recon.add.title': 'Adicionar conta bancária',
  'financial.recon.add.sub': 'Disponível quando o backend (#168) expuser o cadastro de contas.',
  ...
  'financial.recon.add.field.alias': 'Apelido',
  ...
  'financial.recon.add.save': 'Salvar conta',
