...
export const ptBR: Catalog = {
  ...
  'financial.list.remittance.check': 'Conferir remessa',
  'financial.list.remittance.needApproved': 'Selecione títulos Aprovados para conferir a remessa',
  'financial.remittance.preview.title': 'Conferir remessa',
  'financial.remittance.preview.subtitle':
    'O que sairia e o que não sairia neste lote. Conferir não gera arquivo nem envia pagamento ao banco.',
  'financial.remittance.preview.notApproved':
    'título(s) selecionado(s) não estão Aprovados e ficaram de fora — só título aprovado entra em remessa.',
  'financial.remittance.preview.empty': 'Nenhum título para conferir.',
  'financial.remittance.preview.close': 'Fechar',
  'financial.remittance.preview.summary.ready': 'Prontos',
  'financial.remittance.preview.summary.blocked': 'Impedidos',
  'financial.remittance.preview.summary.outOfVan': 'Fora da VAN',
  'financial.remittance.preview.summary.notFound': 'Não encontrados',
  'financial.remittance.preview.col.status': 'Situação',
  'financial.remittance.preview.col.supplier': 'Fornecedor',
  'financial.remittance.preview.col.document': 'Documento',
  'financial.remittance.preview.col.reason': 'O que falta',
  'financial.remittance.preview.col.net': 'Líquido',
  'financial.remittance.preview.status.ready': 'Entra',
  'financial.remittance.preview.status.blocked': 'Impedido',
  'financial.remittance.preview.status.outOfVan': 'Fora da VAN',
  'financial.remittance.preview.status.notFound': 'Não encontrado',
  'financial.remittance.preview.route.pix': 'PIX',
  'financial.remittance.preview.route.transfer': 'Transferência',
  'financial.remittance.preview.route.billet': 'Boleto',
  'financial.remittance.preview.route.taxGuide': 'Guia de tributo',
