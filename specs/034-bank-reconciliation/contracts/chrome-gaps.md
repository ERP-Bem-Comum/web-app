...
| Seleção de conta no workspace (consequência de #168)                      | **core-api#168** | TELA 2 usa **seletor temporário que lê uma conta-cedente do seed** para destravar import/conciliação ponta-a-ponta.                                         | `account-selector.binding.ts` lê do seed agora; troca para o grid real quando #168 chegar (mesma porta).                                                                 |
