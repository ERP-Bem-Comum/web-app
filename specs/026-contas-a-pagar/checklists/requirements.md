...
- **Limites de escopo dirigidos pelo backend (Fatia 1)** estão documentados em *Assumptions* e *Fora de
  escopo* — não são lacunas da spec, são fronteiras conhecidas e aceitas: listagem é stub (grid só com
