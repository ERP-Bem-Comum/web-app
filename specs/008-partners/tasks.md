...
> client core-api (`coreapi/core-api-collaborators.ts` — ⚠️ pasta `coreapi/` contorna o glob `core-api/`),
> composition e 4 server-fns (T029/T030, T009) ✅ — lint/typecheck/31 testes verdes.
