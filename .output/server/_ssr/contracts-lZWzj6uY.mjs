...
//#region node_modules/.nitro/vite/services/ssr/assets/contracts-lZWzj6uY.js
...
createServerFn({ method: "POST" }).middleware([authMiddleware]).inputValidator(ContractCreateInputSchema).handler(createSsrRpc("362cb3e91c809b23fa9aa028a9af6edeee9f16e7e614ba712b3b4e936d33854a"));
var getContractHistory = createServerFn({ method: "GET" }).middleware([authMiddleware]).inputValidator(object({ id: number() })).handler(createSsrRpc("3ad6ac5a0a6984a4132c4eed501205fa0c56f2e1c01a6eeec70870aa8f2f0a55"));
//#endregion
export { getContracts as a, getContractHistory as i, deleteContract as n, updateContract as o, getContractById as r, createContract as t };
